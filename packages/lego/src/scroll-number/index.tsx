...
const ScrollNumber = forwardRef<ScrollNumberRef, ScrollNumberProps>((props, ref) => {
  ...
  return <div ref={countUpRef} className={classNames('wrap', `${className}`)} style={style} />;
});
