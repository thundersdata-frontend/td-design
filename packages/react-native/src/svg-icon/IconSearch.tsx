...
<path fill-rule="evenodd" clip-rule="evenodd" d="M17.4873 17.9552C17.7798 17.6619 18.2547 17.6613 18.548 17.9538L22.072 21.4687C22.3653 21.7612 22.3659 22.2361 22.0734 22.5294C21.7808 22.8227 21.306 22.8233 21.0127 22.5308L17.4887 19.0159C17.1954 18.7234 17.1948 18.2485 17.4873 17.9552Z" fill="${getIconColor(color, 1, '#999999')}"/>
</svg>
`
