...
public class AmapSearchModule extends ReactContextBaseJavaModule
    implements PoiSearch.OnPoiSearchListener, RoutePOISearch.OnRoutePOISearchListener {
  ...
  @ReactMethod
  public void aMapPOIAroundSearch(double latitude, double longitude, String keywords, Integer radius, String city,
      Boolean special, Integer page, Integer pageSize, String types, Callback callback) {
    this.jsCallBack = callback;
    this.doAMapPOIAroundSearch(latitude, longitude, keywords, radius, city, special, page, pageSize, types);
  }

  @ReactMethod
  public void aMapPOIKeywordsSearch(String keywords, String city, String types, Boolean cityLimit, Integer page,
      Integer pageSize, Callback callback) {
    this.jsCallBack = callback;
    this.doAMapPOIAroundSearch(keywords, city, types, cityLimit, page, pageSize);
  }

  @ReactMethod
  public void aMapPOIPolygonSearch(ReadableArray points, String keywords, Integer page, Integer pageSize, String types,
      Callback callback) {
    this.jsCallBack = callback;
  ...
  @ReactMethod
  public void aMapRoutePOISearch(ReadableMap origin, ReadableMap destination, Integer strategy, Integer searchType,
      Integer range, Callback callback) {
    this.jsCallBack = callback;
   ...
   * 开始进行poi搜索
   */
  protected void doAMapPOIAroundSearch(double latitude, double longitude, String keywords, Integer radius, String city,
      Boolean special, Integer page, Integer pageSize, String types) {
   ...
   * 开始进行poi搜索
   */
  protected void doAMapPOIAroundSearch(String keywords, String city, String types, Boolean cityLimit, Integer page,
      Integer pageSize) {
    System.out.println("===>doSearchQuery");
   ...
   * 周边搜索
   */
  protected void doAMapPOIAroundSearch(ReadableArray points, String keywords, Integer page, Integer pageSize,
      String types) {
    System.out.println("===>doSearchQuery");
   ...
   * 道路沿途检索POI
   */
  protected void doRoutePOISearch(ReadableMap origin, ReadableMap destination, Integer strategy, Integer searchType,
      Integer range) {
